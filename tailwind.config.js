...
module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        radial:
          'radial-gradient( circle at 75% 30%,#fefefe 5px,aqua 8%,#3b2d60 60%,#3b2d60 100%)',
      },
      boxShadow: {
        radial:
          'inset 0 0 20px #fff, inset 10px 0 46px #e78dd2e5,inset 88px 0px 60px #e78dd2e5, inset -20px -60px 100px #e78dd2e5,inset 0 50px 140px #e78dd2e5, 0 0 90px #e78dd2e5',
      },
      animation: {
