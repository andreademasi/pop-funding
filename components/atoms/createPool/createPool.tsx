...
const CreatePool = ({ dbInstance, getPools, setCreate }: CreatePoolProps) => {
  ...
  return (
    <div className="m-100% fixed top-1/2 left-1/2 z-50 flex w-[80%] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-2xl bg-purple p-8 shadow-2xl md:w-1/2">
      <div
